...
const Home: React.FC = () => {
    ...
    const [chooseProjectId, setChooseProjectId] = useState<number | null>(null);
    ...
    const openViewDetailModal = (projectId: number) => {
        setChooseProjectId(projectId);
    ...
    return (
        <div className="bg-gray-100 dark:bg-gray-900 w-[123%] ml-[-132px]">
                                    ...
                                    {projects.filter(project => !project.projectDeleteStatus).map(project => (
                                        ...
                                        >
                                            <td className="px-6 py-4 flex gap-2">
                                                ...
                                                <button 
                                                    onClick={() => openViewDetailModal(project.projectId)}
                                                    className="p-1 rounded-md bg-green-500 hover:bg-green-600 text-white transition-colors" title="View">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className='h-3 w-3'>
            ...
            {isProjectDetailOpen && chooseProjectId && (
                <ProjectDetail isOpen={isProjectDetailOpen} onClose={() => setIsProjectDetailOpen(false)} currentProjectId={chooseProjectId} />
            )}
        </div>
    );
};
